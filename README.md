...
**A representation of our forecasted multiVariate time series model is shown below:**
...
**This is the data dictionary for data used in this analysis:**
...
| primary_care_physicians_rate                  | Ratio (County Pop./Number Of PCPS)                           | percent_disabled                                              | Percent                          |
...
| violent_crime_rate                            | Number Of Violent Crimes/100,000 Pop.                       | cpm_18                                                        | Average Cost Per Meal            |
